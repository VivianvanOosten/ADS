...
Answer: Unsupervised (could be supervised if you have that data)
...
C: Unsupervised
D: Unsupervised (could be supervised if you have that data)
E: Unsupervised
...
4. __Make sure you can output the R Markdown file you created to a html using `Knit > Knit to HTML` on top of the source pane.__
...
View(Default)
# it contains the table 'Default' with columns default, student, balance, income
```
